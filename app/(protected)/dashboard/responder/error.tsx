...
type SurveyResponderErrorPageProps = {
  error: Error & { digest?: string };
  reset: () => void;
};

export default function SurveyResponderErrorPage({
  error,
  reset,
}: SurveyResponderErrorPageProps) {
  useEffect(() => {
    console.error("Error en dashboard/responder:", error);
  }, [error]);
    ...
    <div className="bg-zinc-50 p-8">
      <div className="mx-auto w-full max-w-2xl rounded-2xl border border-red-200/60 bg-red-50 p-10 shadow-sm">
        ...
        <h2 className="text-xl font-semibold tracking-tight text-zinc-900">
          No se pudieron cargar las encuestas disponibles
        </h2>
